    ...
    public function index(Request $request)
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.index')->with('success', 'Transaksi berhasil disimpan.');
        } catch (\Exception $e) {
            DB::rollback();
    ...
    {
        $transaction->delete();
        return redirect()->route('admin.index')->with('success', 'Transaksi berhasil dihapus.');
    }

    public function delete($nama_pembeli, $created_at)
{
    // Temukan transaksi berdasarkan nama_pembeli dan created_at
    $transactions = Transaction::where('nama_pembeli', $nama_pembeli)
...
public function statusUpdate($nama_pembeli, $created_at, $status)
{
    // Temukan transaksi berdasarkan nama_pembeli dan created_at
    $transactions = Transaction::where('nama_pembeli', $nama_pembeli)
        ->where('created_at', $created_at)
