<nav class=" flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all ease-in shadow-none duration-250 rounded-2xl lg:flex-nowrap lg:justify-start sticky top-[1%] backdrop-saturate-200 backdrop-blur-2xl dark:bg-slate-850/80 dark:shadow-dark-blur bg-[hsla(0,0%,100%,0.8)] shadow-blur z-110" navbar-main navbar-scroll="true">
    <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
      <nav>
        <h6 class="mb-0 font-bold dark:text-white capitalize text-black" id="current-page">Dashboard</h6>
      </nav>
        ...
        <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
          ...
          <li class="flex items-center">
            ...
            @csrf
            <button type="submit" class="block px-0 py-2 text-sm font-semibold dark:text-white transition-all ease-nav-brand">
                <i class="fa fa-user sm:mr-1 text-black"></i>
                <span class="hidden sm:inline text-black">Sign Out</span>
            </button>
        </form>
          </li>
          {{-- <li class="flex items-center pl-4 xl:hidden">
            <a href="javascript:;" class="block p-0 text-sm text-white transition-all ease-nav-brand" sidenav-trigger>
              <div class="w-4.5 overflow-hidden">
                ...
                <i class="ease mb-0.75 relative block h-0.5 rounded-sm bg-black dark:bg-white transition-all"></i>
                <i class="ease relative block h-0.5 rounded-sm bg-black dark:bg-white transition-all"></i>
              </div>
            </a>
          </li>
          ...
          {{-- <li class="relative flex items-center pr-2">
            ...
            <a href="javascript:;" class="block p-0 text-sm dark:text-white transition-all ease-nav-brand" dropdown-trigger aria-expanded="false">
